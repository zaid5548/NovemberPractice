...
//		System.out.println(EditDistanceRecursionVidx(s1, s2, 0, 0));
	...
	public static int EditDistanceRecursionVidx(String s1, String s2, int vidx1, int vidx2) {
	...
	public static int EditDistanceTD(String s1, String s2, int vidx1, int vidx2,int[][] strg) {
		...
		if (ch1 == ch2) {
			ans = EditDistanceTD(s1, s2, vidx1 + 1, vidx2 + 1,strg);
		} else {
			int i = EditDistanceTD(s1, s2, vidx1 + 1, vidx2,strg);
			int d = EditDistanceTD(s1, s2, vidx1, vidx2 + 1,strg);
			int r = EditDistanceTD(s1, s2, vidx1 + 1, vidx2 + 1,strg);
